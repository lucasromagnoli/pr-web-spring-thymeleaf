...
@Controller
@RequestMapping(ControllerMapping.WEB_PATH_ERRORS_ROOT)
public class ErrorsController {

	@GetMapping(ControllerMapping.WEB_PATH_ERRORS_404)
	public ModelAndView pathNotFound() {
		return new ModelAndView(ControllerMapping.VIEW_ERRORS_404);
	}
	
	@GetMapping(ControllerMapping.WEB_PATH_ERRORS_500)
	public ModelAndView internalServerError() {
		return new ModelAndView(ControllerMapping.VIEW_ERRORS_500);
	}
	
	@GetMapping(ControllerMapping.WEB_PATH_ERRORS_GENERIC_MODULAR)
